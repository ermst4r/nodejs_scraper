...
var websiteName = "zflipit_be";
var websiteUrl = 'http://www.flipit.com/be/';
var util = require("util");
var parsedJSON = require('../shopnames/be_match.json');
...
var Flipit_be = function () {
    this.fetchData = function () {
        ...
        uriPath[0] = 'alle-winkels-09-e';
        uriPath[1] = 'alle-winkels-f-j';
        uriPath[2] = 'alle-winkels-k-o';
        uriPath[3] = 'alle-winkels-p-t';
        uriPath[4] = 'alle-winkels-u-z';
                        ...
                        request({
                            ...
                            if (!pageError && pageResponse.statusCode == 200) {
                                ...
                                d('.holder.offer-holder').each(function () {
                                    ...
                                    if (isOffer.trim().toLowerCase().replace(/ /g, '') == 'bekijkdezeactie') {
                                    ...
                                    if(detail.find('.offer-teaser-button.kccode').text()=='bekijk de code') {
                                        if(codeUrl !='') {
                                            request({
                                                uri: codeUrl
